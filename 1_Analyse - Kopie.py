...
if not filtered.empty:
    ...
    # ISO3-Codes hinzufügen (risk muss iso3 enthalten)
    ...
    fig_map = px.choropleth(
        ...
        color="dependency",                   # Risiko-Wert
        hover_name="country_name",            # Tooltip
        color_continuous_scale="Reds",        # Farbskala
        projection="natural earth",           # Weltkarten-Projektion
